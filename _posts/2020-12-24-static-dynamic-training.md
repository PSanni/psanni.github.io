...
Therefore, choice of training type is more concered with needs and type of dataset. Some problems are more dynamic in nature and models are severly affected with drifting in data overtime, hence, requres a continues training. Whereas, problems like document ranking are more static in nature, and requres static training. :) 
